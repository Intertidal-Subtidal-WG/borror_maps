...
ggsave(here('figures', 'exposed-protected.png'), device = png, height = 3.5, width = 3, units = 'in')
```
...
plot_usmap(include = .new_england, fill = 'grey88') +
  theme(panel.background = element_rect(fill = '#94b4d8'))

ggsave(here('figures', 'new-england.png'), device = png, height = 3.5, width = 3, units = 'in')
```
...
transects <- read_csv(here("data","transects","transect_info_decimals.csv"))
