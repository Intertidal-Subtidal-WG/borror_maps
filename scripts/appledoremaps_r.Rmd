...
```{r load data}
ct_data <- read.csv('./data/transects/ct_clean.csv')
transect_info <- read.csv('./data/transects/transect_info_decimals.csv')
```
...
#,13,15,20,22,24,26,28


apple_points <- ggmap(apple_toner) +
  geom_point(data = test_point, aes( x = lon, y = lat, color = 'red'))
